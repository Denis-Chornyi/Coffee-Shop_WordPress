  ...
  const n = function (t) {
    ...
    s = function (t, e) {
      return function (n, r) {
        const i = t[e];
        return void 0 !== r
          ? n in i && i[n].handlers.some((t) => t.namespace === r)
          : n in i;
      };
    },
    c = function (t, e, n, r) {
  ...
  class d {
    constructor() {
      (this.actions = Object.create(null)),
        ...
        (this.removeAction = o(this, "actions")),
        (this.removeFilter = o(this, "filters")),
        (this.hasAction = s(this, "actions")),
        (this.hasFilter = s(this, "filters")),
        (this.removeAllActions = o(this, "actions", !0)),
        (this.removeAllFilters = o(this, "filters", !0)),
